...
import { AdminService, TorreAlerta } from '../../core/services/admin.service';
...
export class AdminTorreComponent implements OnInit {
  alertas = signal<TorreAlerta[]>([]);
  loading = signal(true);
