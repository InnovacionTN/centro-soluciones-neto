...
let EvidenciasComponent = class EvidenciasComponent {
    constructor(http) {
        this.http = http;
        this.canUpload = false;
        this.token = '';
        this.api = environment.apiUrl;
        this.evidencias = signal([]);
    ...
    loadEvidencias() {
        ...
        this.http.get(`${this.api}/tickets/${this.ticketId}/evidencias`).subscribe({
    ...
    onFileSelect(event) {
        ...
        const upload = (idx) => {
            ...
            this.http.post(`${this.api}/tickets/${this.ticketId}/evidencias`, formData).subscribe({
                next: ev => {
...
__decorate([
    Input()
], EvidenciasComponent.prototype, "ticketId", void 0);
__decorate([
    Input()
], EvidenciasComponent.prototype, "canUpload", void 0);
__decorate([
    Input()
], EvidenciasComponent.prototype, "token", void 0);
EvidenciasComponent = __decorate([
    Component({
...
export { EvidenciasComponent };
//# sourceMappingURL=evidencias.component.js.map