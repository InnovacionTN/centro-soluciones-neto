...
let AdminIncidentesComponent = class AdminIncidentesComponent {
    constructor(adminService) {
        this.adminService = adminService;
        this.incidentes = signal([]);
        this.loading = signal(true);
        this.saving = signal(false);
        this.cerrando = signal(null);
        this.error = signal('');
        this.mostrarForm = signal(false);
        this.filtroEstado = '';
        this.nuevoTitulo = '';
        this.nuevoDesc = '';
    }
...
AdminIncidentesComponent = __decorate([
    Component({
...
export { AdminIncidentesComponent };
//# sourceMappingURL=admin-incidentes.component.js.map