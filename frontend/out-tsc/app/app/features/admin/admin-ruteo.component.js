...
let AdminRuteoComponent = class AdminRuteoComponent {
    constructor(admin) {
        this.admin = admin;
        this.reglas = signal([]);
        this.tips = signal([]);
    ...
    save() {
        if (!this.form.tipificacion_id || !this.form.grupo_id) {
            this.formError.set('Tipificación y grupo son obligatorios');
            return;
        }
...
export { AdminRuteoComponent };
//# sourceMappingURL=admin-ruteo.component.js.map